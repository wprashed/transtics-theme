...
<section class="header-top">
   <h4 class="d-none">header-top</h4>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <p class="float-left alignleft d-flex justify-content-between">
                ...
                <p class="float-right right alignrigh">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 col-sm-9 col-8">
                ...
                <span class="right float-right alignrigh">
                  ...
                  <a href="<?php echo esc_url($transtics['get_quote_url']); ?>" class="btn quate float-right alignrigh"><?php echo esc_html($transtics['get_quote_text']); ?></a>
                  <?php } ?>
                  <?php endif ?>
                </span>
            </div>
