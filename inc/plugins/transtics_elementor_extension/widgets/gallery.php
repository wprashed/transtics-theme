...
class Transtics_Gallery_widget extends \Elementor\Widget_Base {
	...
	function register_controls() {
		...
		$this->start_controls_section(
			'backgrount_section',
			[
				'label' => __( 'Gallery Controls', 'transticsee' ),
		    ...
		    <div class="container">
		        <div class="row">
		            <div class="col-md-12">
		                ...
		                <h5><a href="{{ settings.button_url.url }}" {{ target }}{{ nofollow }} class="btn">{{{ settings.button_text }}}</a></h5>
		            </div>
		        </div>
		    </div>
		</section>
