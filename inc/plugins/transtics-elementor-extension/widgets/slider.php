...
class Transtics_Slider_widget extends \Elementor\Widget_Base {
	...
	function register_content_controls() {
		...
		$this->add_control(
			'dummy_text',
			[
				'label'       => __( 'Dummy Text', 'transticsee' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'input_type'  => 'text',
				'placeholder' => __( 'Some Dummy Text', 'transticsee' ),
				'default'     => __( 'Transtics Elementor Extension', 'transticsee' ),
			]
		);
	...
	protected function register_style_controls() {
		...
		$this->start_controls_section(
			'style_section',
			[
				'label' => __( 'Text Style', 'transticsee' ),
